...
% the matlab function file 'NChainedGradFlow.m'. 
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% paramaters
tic;
...
w = 0;       % strength of vdw interaction
...
[T,Y] = ode45(@threeAtom_torSpring,t,init,options,eta,mu,D,w,sigma,hl,hr,H,k,l,Nafix,Nafree);
