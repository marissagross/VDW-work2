...
D = 2;       % distance between walls. Here the origin is set at 0. the walls are at +- D/2
...
% set initial conditions
    ...
    for i = 1:Nafree
        ...
        init(2*i) = 0.15*i;    % y initial positions
    end
...
[T,Y] = ode45(@buckling_force,t,init,options,eta,mu,D,w,sigma,hl,hr,H,k,l,Nafix,Nafree,push);
...
plot(Y(end,1:2:end),Y(end,2:2:end),'-') % plots where they end up
